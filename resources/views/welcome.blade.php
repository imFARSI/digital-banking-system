{{-- Page: Public landing page showcasing Finexa features with login/register CTA --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <nav class="finexa-nav">
        ...
        <div class="nav-links">
            ...
            <a href="{{ route('register') }}" class="btn-nav-register ms-2">Open Account</a>
        </div>
    </nav>
    ...
    <footer class="finexa-footer">
        ...
        <p class="mb-0">© {{ date('Y') }} Finexa. All rights reserved. &nbsp;|&nbsp; <a href="{{ route('login') }}" style="color:rgba(255,255,255,0.4); text-decoration:none;">Login</a> &nbsp;|&nbsp; <a href="{{ route('register') }}" style="color:rgba(255,255,255,0.4); text-decoration:none;">Register</a></p>
    </footer>
