...
<head>
    ...
    <title>Finexa Banking — <?php echo $__env->yieldContent('page_title', 'Dashboard'); ?></title>
...
<body>
    ...
    <!-- ── SIDEBAR ── -->
    <div class="sidebar">
        <a href="<?php echo e(Auth::user()->isAdmin() ? route('admin.dashboard') : route('dashboard')); ?>" class="sidebar-brand">
        ...
        <nav>
            <?php if(Auth::user()->isAdmin()): ?>
                ...
                <a class="nav-link <?php echo e(request()->routeIs('admin.loans') ? 'active' : ''); ?>" href="<?php echo e(route('admin.loans')); ?>">
                    <i class="bi bi-cash-coin"></i> Loan Approvals
                </a>
                <a class="nav-link <?php echo e(request()->routeIs('admin.cards_accounts') ? 'active' : ''); ?>" href="<?php echo e(route('admin.cards_accounts')); ?>">
                    <i class="bi bi-credit-card"></i> Manage Cards & Accounts
                </a>
                <a class="nav-link <?php echo e(request()->routeIs('admin.support*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.support')); ?>">
                    <i class="bi bi-headset"></i> Support Tickets
                </a>
                <a class="nav-link <?php echo e(request()->routeIs('admin.transactions') ? 'active' : ''); ?>" href="<?php echo e(route('admin.transactions')); ?>">
            ...
            <?php else: ?>
                ...
                <a class="nav-link <?php echo e(request()->routeIs('services.cards') ? 'active' : ''); ?>" href="<?php echo e(route('services.cards')); ?>">
                    <i class="bi bi-credit-card"></i> My Cards
                </a>
                <a class="nav-link <?php echo e(request()->routeIs('services.loans') ? 'active' : ''); ?>" href="<?php echo e(route('services.loans')); ?>">
                    <i class="bi bi-cash-coin"></i> Loans
                </a>
                <a class="nav-link <?php echo e(request()->routeIs('services.savings') ? 'active' : ''); ?>" href="<?php echo e(route('services.savings')); ?>">
                    <i class="bi bi-piggy-bank"></i> Savings Plans
                </a>
                <a class="nav-link <?php echo e(request()->routeIs('services.payments') ? 'active' : ''); ?>" href="<?php echo e(route('services.payments')); ?>">
                    <i class="bi bi-receipt"></i> Bill Payments
                </a>
                <div class="nav-section-label">More</div>
                <a class="nav-link <?php echo e(request()->routeIs('services.rewards') ? 'active' : ''); ?>" href="<?php echo e(route('services.rewards')); ?>">
                    <i class="bi bi-gift"></i> Rewards
                </a>
                <a class="nav-link <?php echo e(request()->routeIs('support.*') ? 'active' : ''); ?>" href="<?php echo e(route('support.index')); ?>">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3 p-0" aria-labelledby="notificationDropdown" style="width: 320px; animation: dropdownFade 0.2s ease;">
                        <div class="p-3 border-bottom d-flex justify-content-between align-items-center bg-light rounded-top-3">
                            ...
                            <?php if(Auth::user()->unreadNotifications->count() > 0): ?>
                                <form action="<?php echo e(route('notifications.read.all')); ?>" method="POST" class="m-0">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div style="max-height: 350px; overflow-y: auto;">
                            <?php $__empty_1 = true; $__currentLoopData = Auth::user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <a href="<?php echo e(route('notifications.read', $notification->id)); ?>" class="dropdown-item p-3 border-bottom text-wrap" style="transition: background 0.2s;">
                                    <div class="d-flex gap-3">
                                        <div class="bg-<?php echo e($notification->data['color'] ?? 'primary'); ?> bg-opacity-10 text-<?php echo e($notification->data['color'] ?? 'primary'); ?> rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 35px; height: 35px;">
                                            <i class="bi <?php echo e($notification->data['icon'] ?? 'bi-bell'); ?>"></i>
                                        </div>
                                        <div>
                                            <div class="fw-bold mb-1" style="font-size: 0.85rem;"><?php echo e($notification->data['title'] ?? 'Notification'); ?></div>
                                            <div class="text-muted mb-1" style="font-size: 0.75rem; line-height: 1.3;"><?php echo e($notification->data['message'] ?? ''); ?></div>
                                            <div class="text-secondary" style="font-size: 0.65rem;"><?php echo e($notification->created_at->diffForHumans()); ?></div>
                                        </div>
                                    </div>
                                </a>
                ...
                <div class="dropdown">
                    <button class="profile-btn dropdown-toggle-no-caret" id="profileDropdown"
                        ...
                        <div class="text-start">
                            <div class="profile-name"><?php echo e(Auth::user()->name ?? 'User'); ?></div>
                            <div class="profile-role"><?php echo e(Auth::user()->isAdmin() ? 'Administrator' : 'Customer'); ?></div>
                        </div>
...
<?php /**PATH D:\Finexa\resources\views/layouts/app.blade.php ENDPATH**/ ?>