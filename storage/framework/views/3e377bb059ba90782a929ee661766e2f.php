        ...
        <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #0A2540 0%, #1a4b77 100%); border-radius: 16px;">
            <div class="card-body text-white position-relative overflow-hidden">
                <div style="position: relative; z-index: 2;">
                    ...
                    <h2 class="mb-0 fw-bold"><?php echo e(number_format($totalUsers)); ?></h2>
                </div>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100" style="border-radius: 16px;">
            <div class="card-body">
                ...
                <h3 class="mb-0 fw-bold text-dark">৳<?php echo e(number_format($systemBalance, 0)); ?></h3>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm h-100" style="border-radius: 16px;">
            <div class="card-body">
                ...
                <h3 class="mb-0 fw-bold text-dark"><?php echo e(number_format($todayTransactions)); ?></h3>
                <p class="text-success small mb-0 fw-medium mt-1"><i class="bi bi-graph-up me-1"></i>৳<?php echo e(number_format($todayVolume, 0)); ?> vol</p>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="mt-2">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        ...
                        <span class="badge bg-warning text-dark rounded-pill"><?php echo e($pendingLoans); ?></span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="small fw-medium text-dark">Support Tickets</span>
                        <span class="badge <?php echo e($openTickets > 0 ? 'bg-danger' : 'bg-success'); ?> rounded-pill"><?php echo e($openTickets); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="card border-0 shadow-sm mb-4" style="border-radius: 16px;">
    ...
    <div class="card-body px-4 pb-4">
        <div class="row g-3">
            ...
            <div class="col-md-3">
                <a href="<?php echo e(route('admin.users.index')); ?>" class="text-decoration-none d-block h-100">
            ...
            <div class="col-md-3">
                <a href="<?php echo e(route('admin.loans')); ?>" class="text-decoration-none d-block h-100">
                    <div class="card border-1 h-100 p-3 rounded-4 action-card" style="transition: all 0.2s; border-color: #e2e8f0;">
                        <div class="d-flex align-items-center gap-3">
            ...
            <div class="col-md-3">
                <a href="<?php echo e(route('admin.support')); ?>" class="text-decoration-none d-block h-100">
                    <div class="card border-1 h-100 p-3 rounded-4 action-card" style="transition: all 0.2s; border-color: #e2e8f0;">
                        <div class="d-flex align-items-center gap-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Finexa\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>